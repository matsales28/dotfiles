...
plugins=(git rails ruby bundler zsh-autosuggestions zsh-syntax-highlighting)
...
alias factory="tilix --session tilix.json"
alias rtt="rails test"
function giap() {
    gaa
    if [ "$1" != "" ] 
    then
